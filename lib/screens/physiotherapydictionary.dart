...
class SingleWord extends StatefulWidget {
  ...
  SingleWord({required this.word, required this.meaning,});
...
class SingleWordContentScreen extends StatefulWidget {
  ...
  SingleWordContentScreen({required this.word, required this.meaning,});

  @override
  _SingleWordContentScreenState createState() => _SingleWordContentScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          Padding(
            padding: const EdgeInsets.only(left: 30.0, right: 35, top: 35, bottom: 0,),
            child: Text("Word :",style: TextStyle(fontSize: 30, fontWeight: FontWeight.w600, fontFamily: 'QuickSand',),),
          ),
          Padding(
            padding: const EdgeInsets.only(left: 35.0, top: 8.0,),
            child: Text(widget.word, style: TextStyle(fontSize: 55, fontWeight: FontWeight.w700, fontFamily: 'QuickSand',),),
          ),
          Padding(
            padding: const EdgeInsets.only(left: 30.0, right: 35, top: 35, bottom: 0,),
            child: Text("Meaning :",style: TextStyle(fontSize: 30, fontWeight: FontWeight.w600, fontFamily: 'QuickSand',),),
          ),
          Padding(
            padding: const EdgeInsets.only(left: 23.0, right: 12, top: 10, bottom: 0,),
            child: Material(
              elevation: 2,
              borderRadius: BorderRadius.circular(20),
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text(widget.meaning,style: TextStyle(fontFamily: 'QuickSand',letterSpacing: 0.3,fontSize: 17,),),
                ),
              ),
            ),
          ),
